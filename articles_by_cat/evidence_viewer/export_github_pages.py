...
.page-navigator .items-list {
  border-top: 1px solid var(--viewer-border);
}

.page-navigator .items-list a {
  display: block;
  padding: 10px 0;
  text-decoration: none;
...
.page-sidebar .actions-buttons.sidebar .viewer-action-button,
.page-sidebar .actions-buttons .viewer-action-button {
  width: 100% !important;
  ...
  color: var(--viewer-link) !important;
  font: inherit;
  font-size: 0.98rem;
  font-weight: 600;
  text-align: left;
...
.page-sidebar .viewer-action-button .button-label {
  display: inline;
  color: inherit;
}

.page-sidebar .actions-buttons .viewer-action-button + .viewer-action-button {
  border-top: 1px solid var(--viewer-border);
}

.page-sidebar .viewer-action-button:hover,
.page-sidebar .viewer-action-button:focus-visible {
