const DATASET_OPTIONS = [
  ...
  { file: "./viewer_data_test10_all.json", label: "test_10" },
  { file: "./viewer_data_test10_2_all.json", label: "test_10_2" },
  { file: "./viewer_data_test10_5_4_all.json", label: "test_10_5.4" },
];
