const DATASET_OPTIONS = [
  ...
  { file: "./viewer_data_test10_all.json", label: "test_10", summaryFile: "./test_summarization_out.jsonl" },
  { file: "./viewer_data_test10_2_all.json", label: "test_10_2", summaryFile: "./test_summarization_out.jsonl" },
  { file: "./viewer_data_test10_5_4_all.json", label: "test_10_5.4", summaryFile: "./test_summarization_out.jsonl" },
];
const VIEWER_CACHE_VERSION = "20260416a";
